...
+(instancetype)initWithDateTimePickerView
{
    ...
    return [[[NSBundle mainBundle] loadNibNamed:@"DateTimePickerView" owner:nil options:nil]lastObject];
...
- (IBAction)removeBtnClick:(id)sender {
    ...
    [self.delegate getSelectDateTime:self.selectDate type:self.type button:sender];
}
