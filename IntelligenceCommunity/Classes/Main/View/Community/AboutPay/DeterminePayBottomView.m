...
//    @property(nonatomic,strong) UILabel *selectAllLabel;
    ...
    [_selectAllCommodityButton setImage:[UIImage imageNamed:@"Selected"] forState:UIControlStateNormal];
...
//    @property(nonatomic,strong) UIButton *commitOrderButton;
    ...
    [_commitOrderButton setBackgroundColor:HexColor(0xfe9913)];
    ...
    [_commitOrderButton mas_makeConstraints:^(MASConstraintMaker *make) {
        ...
        make.width.mas_offset(kGetHorizontalDistance(248));
    }];
