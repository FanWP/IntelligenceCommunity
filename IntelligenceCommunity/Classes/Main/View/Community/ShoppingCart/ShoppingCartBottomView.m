...
//    @property(nonatomic,strong) UIButton *shoppingCartButton;
    ...
    [_shoppingCartButton setImage:[UIImage imageNamed:@"gouwu"] forState:UIControlStateNormal];
...
//    @property(nonatomic,strong) UILabel *commodityCountLabel;
    ...
    _commodityCountLabel.backgroundColor = [UIColor redColor];
...
//    @property(nonatomic,strong) UILabel *commodityTotalPriceLabel;
    ...
    _commodityTotalPriceLabel.textColor = [UIColor blackColor];
    ...
    [_commodityTotalPriceLabel mas_makeConstraints:^(MASConstraintMaker *make) {
        make.centerY.mas_equalTo(_shoppingCartButton.mas_centerY);
        make.left.equalTo(_shoppingCartButton.mas_right).offset(20);
...
//    @property(nonatomic,strong) UIButton *goSettlementButton;
    ...
    _goSettlementButton.backgroundColor = [UIColor orangeColor];
